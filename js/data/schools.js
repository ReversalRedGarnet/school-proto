...
SF.SCHOOLS = [
  /* ---- Honiara cluster (dense, so the default map view isn't sparse) ---- */
  {
    ...
    phone: '+677 21140', email: 'admin@panatina.edu.sb', website: 'https://example.edu.sb/panatina',
  ...
  },
  {
    ...
    phone: '+677 21073', email: 'office@stnicholas.edu.sb', website: 'https://example.edu.sb/st-nicholas',
  ...
  },
  {
    ...
    phone: '+677 21988', email: 'hello@mataniko.edu.sb', website: 'https://example.edu.sb/mataniko',
  ...
  },
  {
    ...
    phone: '+677 22415', email: 'enquiries@holycross.edu.sb', website: 'https://example.edu.sb/holy-cross',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 13 },
  ...
  },
  {
    ...
    phone: '+677 30122', email: 'registrar@betikama.edu.sb', website: 'https://example.edu.sb/betikama',
  ...
  },
  {
    ...
    phone: '+677 25604', email: 'naha.elc@example.edu.sb', website: 'https://example.edu.sb/naha-elc',
  ...
  },
  {
    ...
    phone: '+677 24700', email: 'info@hti.edu.sb', website: 'https://example.edu.sb/hti',
  ...
  },
  {
    ...
    phone: '+677 23311', email: 'admin@kukumacademy.edu.sb', website: 'https://example.edu.sb/kukum-academy',
    educationLevels: ['Early Childhood', 'Primary'], yearLevels: { min: 1, max: 6 },
  ...
  },
  {
    ...
    phone: '+677 21562', email: 'office@rovegirls.edu.sb', website: 'https://example.edu.sb/rove-girls',
  ...
  /* ---- Guadalcanal province (outside the capital) ---- */
  {
    ...
    phone: '+677 36420', email: 'tetere.rtc@example.edu.sb', website: 'https://example.edu.sb/tetere-rtc',
  ...
  },
  {
    ...
    phone: '+677 36118', email: 'aolabay@example.edu.sb', website: 'https://example.edu.sb/aola-bay',
  ...
  },
  {
    ...
    phone: '+677 36055', email: 'visale.ps@example.edu.sb', website: 'https://example.edu.sb/visale',
  ...
  },
  {
    ...
    phone: '+677 36901', email: 'avuavu@example.edu.sb', website: 'https://example.edu.sb/avu-avu',
  ...
  /* ---- Malaita ---- */
  {
    ...
    phone: '+677 40213', email: 'auki.pss@example.edu.sb', website: 'https://example.edu.sb/auki-pss',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 13 },
  ...
  },
  {
    ...
    phone: '+677 40877', email: 'maluu.hs@example.edu.sb', website: 'https://example.edu.sb/maluu',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 12 },
  ...
  },
  {
    ...
    phone: '+677 40509', email: 'atori.ps@example.edu.sb', website: 'https://example.edu.sb/atori',
    educationLevels: ['Early Childhood', 'Primary'], yearLevels: { min: 1, max: 6 },
  ...
  },
  {
    ...
    phone: '+677 40644', email: 'afio.rtc@example.edu.sb', website: 'https://example.edu.sb/afio-rtc',
    educationLevels: ['Tertiary/Vocational'], yearLevels: { min: 10, max: 13 },
  ...
  /* ---- Western Province ---- */
  {
    ...
    phone: '+677 60188', email: 'gizo.chs@example.edu.sb', website: 'https://example.edu.sb/gizo-chs',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 13 },
  ...
  },
  {
    ...
    phone: '+677 62240', email: 'munda.college@example.edu.sb', website: 'https://example.edu.sb/munda-college',
    educationLevels: ['Secondary', 'Tertiary/Vocational'], yearLevels: { min: 7, max: 13 },
  ...
  },
  {
    ...
    phone: '+677 61355', email: 'noro.ps@example.edu.sb', website: 'https://example.edu.sb/noro',
    educationLevels: ['Early Childhood', 'Primary'], yearLevels: { min: 1, max: 6 },
  ...
  },
  {
    ...
    phone: '+677 62901', email: 'seghe.academy@example.edu.sb', website: 'https://example.edu.sb/seghe-academy',
  ...
  /* ---- Isabel ---- */
  {
    ...
    phone: '+677 35110', email: 'buala.ass@example.edu.sb', website: 'https://example.edu.sb/buala',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 12 },
  ...
  },
  {
    ...
    phone: '+677 35288', email: 'kia.cs@example.edu.sb', website: 'https://example.edu.sb/kia',
    educationLevels: ['Primary', 'Secondary'], yearLevels: { min: 1, max: 9 },
  ...
  /* ---- Makira-Ulawa ---- */
  {
    ...
    phone: '+677 50133', email: 'kirakira.phs@example.edu.sb', website: 'https://example.edu.sb/kirakira',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 12 },
  ...
  },
  {
    ...
    phone: '+677 50477', email: 'santaana.ps@example.edu.sb', website: 'https://example.edu.sb/santa-ana',
    educationLevels: ['Early Childhood', 'Primary'], yearLevels: { min: 1, max: 6 },
  ...
  /* ---- Temotu ---- */
  {
    ...
    phone: '+677 53080', email: 'lata.ss@example.edu.sb', website: 'https://example.edu.sb/lata',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 11 },
  ...
  /* ---- Choiseul ---- */
  {
    ...
    phone: '+677 63022', email: 'taro.ps@example.edu.sb', website: 'https://example.edu.sb/taro',
  ...
  },
  {
    ...
    phone: '+677 63140', email: 'sasamungga@example.edu.sb', website: 'https://example.edu.sb/sasamungga',
    educationLevels: ['Secondary'], yearLevels: { min: 7, max: 12 },
  ...
  /* ---- Central Province ---- */
  {
    ...
    phone: '+677 32077', email: 'tulagi.hs@example.edu.sb', website: 'https://example.edu.sb/tulagi',
    educationLevels: ['Primary', 'Secondary'], yearLevels: { min: 1, max: 9 },
  ...
  },
  {
    ...
    phone: '+677 32411', email: 'yandina.ss@example.edu.sb', website: 'https://example.edu.sb/yandina',
    educationLevels: ['Secondary', 'Tertiary/Vocational'], yearLevels: { min: 7, max: 13 },
  ...
  /* ---- Rennell and Bellona ---- */
  {
    ...
    phone: '+677 39012', email: 'tigoa.chs@example.edu.sb', website: 'https://example.edu.sb/tigoa',
    educationLevels: ['Primary', 'Secondary'], yearLevels: { min: 1, max: 11 },
